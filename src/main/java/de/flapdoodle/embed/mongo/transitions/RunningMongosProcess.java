	...
	public static RunningProcessFactory<RunningMongosProcess> factory(long startupTimeout, SupportConfig supportConfig, Platform platform, Net net) {
		return (process, processOutput, pidFile, timeout) -> {
			...
			if (logWatch.isInitWithSuccess()) {
				...
				return new RunningMongosProcess(process, pidFile, timeout, closeAllOutputs, supportConfig, platform, net, processOutput.commands(), pid);
				...
				return Try.<RunningMongosProcess, RuntimeException>supplier(() -> {
